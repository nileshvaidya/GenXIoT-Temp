...
const SocketDispatchContext = createContext<ISocketContextProps>({
  SocketDispatch: () => { },
  AddDeviceToSocket: (device_Id) => { },
  RemoveDeviceFromSocket: () => {},
});

export const SocketDispatchContextConsumer = SocketDispatchContext.Consumer;
export const SocketDispatchContextProvider = SocketDispatchContext.Provider;

export default SocketDispatchContext;
